...
void init_anchored_variable(py::module &m)
{
    py::class_<AnchoredVariable>(m, "AnchoredVariable")
        ...
        .def("set", py::overload_cast<const std::string &, size_t>(&AnchoredVariable::set))
        .def("set", py::overload_cast<const std::string &, size_t, size_t>(&AnchoredVariable::set))
        .def("append", py::overload_cast<const std::string &, size_t, bool>(&AnchoredVariable::append))
        .def("append", py::overload_cast<const std::string &, size_t, bool, int>(&AnchoredVariable::append))
        // .def("evaluate", py::overload_cast<std::vector<const VariableValue *> *>(&AnchoredVariable::evaluate))
        .def("evaluate", py::overload_cast<>(&AnchoredVariable::evaluate))
