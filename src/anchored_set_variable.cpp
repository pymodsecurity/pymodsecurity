...
void init_anchored_set_variable(py::module &m)
{
    py::class_<AnchoredSetVariable>(m, "AnchoredSetVariable")
        ...
        .def("set", py::overload_cast<const std::string &, const std::string &, size_t>(&AnchoredSetVariable::set))
        .def("set", py::overload_cast<const std::string &, const std::string &, size_t, size_t>(&AnchoredSetVariable::set))
        .def("setCopy", &AnchoredSetVariable::setCopy)
        // .def("set", py::overload_cast<std::vector<const VariableValue *> *>(&AnchoredSetVariable::set))
        // .def("set", py::overload_cast<const std::string &, std::vector<const VariableValue *> *>(&AnchoredSetVariable::set))
