...
void init_rule_message(py::module &m)
{
    py::class_<RuleMessage>(m, "RuleMessage")
        ...
        // .def_static("_details", (std::string (RuleMessage::*) (const RuleMessage *)) &RuleMessage::_details)
        // .def_static("_errorLogTail", (std::string (RuleMessage::*) (const RuleMessage *)) &RuleMessage::_errorLogTail)
