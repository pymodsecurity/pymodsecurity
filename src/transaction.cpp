...
void init_transaction(py::module &m)
{
    py::class_<Transaction>(m, "Transaction")
        ...
        .def("addRequestHeader", py::overload_cast<const std::string &, const std::string &>(&Transaction::addRequestHeader))
        .def("addRequestHeader", py::overload_cast<const unsigned char *, const unsigned char *>(&Transaction::addRequestHeader))
        .def("addRequestHeader", py::overload_cast<const unsigned char *, size_t, const unsigned char *, size_t>(&Transaction::addRequestHeader))
        ...
        .def("addResponseHeader", py::overload_cast<const std::string &, const std::string &>(&Transaction::addResponseHeader))
        .def("addResponseHeader", py::overload_cast<const unsigned char *, const unsigned char *>(&Transaction::addResponseHeader))
        .def("addResponseHeader", py::overload_cast<const unsigned char *, size_t, const unsigned char *, size_t>(&Transaction::addResponseHeader))
